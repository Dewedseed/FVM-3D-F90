...
!*****************************************************************************************
!
!> From: https://github.com/ivan-pi/fmetis
!!
!!  author: Ivan Pribec,
!!  date: 7/2019
!
...
!```
    ...
    function METIS_SetDefaultOptions_C_Interface(options) result(ierr) bind(C,name="METIS_SetDefaultOptions")
        import idx_t, METIS_NOPTIONS
